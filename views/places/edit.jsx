              ...
              <form method="POST" action={`/places/${data.place.id}?_method=PUT`}>
                <div className='row container'>
                  ...
                  <div className="form-group col-sm-6">
                    ...
                    <input className="form-control" id="cuisines" name="cuisines" value={data.place.cuisines} requirednpm/>
                  </div>
                  <div>
                  <input className="btn btn-primary button" type="submit" value="Edit Place"/>
                  </div>
                </div>
              </form>
          </main>
